		...
		<div class="row">
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
				<div class="card card-signin my-5">
					<div class="card-body">
						<h5 class="card-title text-center">THECUTE LOGIN</h5>
						<form class="form-signin" action="do_login" method="POST">
							<div class="form-label-group">
								<input type="text" id="inputEmail" name="id" class="form-control"
							...
							<a href="join" class="btn btn-lg btn-primary btn-block text-uppercase">Sign up</a>
